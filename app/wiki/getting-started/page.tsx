        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-4 sticky top-20">
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/wiki/bloodmoon" className="text-gray-300 hover:text-red-400 block py-1">
                    Bloodmoon
                  </Link>
                </li>
                <li>
                  <Link href="/wiki/nations-system" className="text-gray-300 hover:text-red-400 block py-1">
                    Nations System
                  </Link>
                </li>
              </ul>
          ...
          <div className="lg:col-span-3">
            <article className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
              <h1 className="text-3xl font-bold mb-2 font-minecraft text-red-500">GETTING STARTED</h1>
              <p className="text-gray-400 italic mb-6">Your guide to surviving your first days in Blothera</p>

              <div className="prose prose-invert max-w-none">
                <p className="text-gray-300 mb-4">
                  Welcome to Blothera, a hardcore Minecraft experience where death has consequences and your actions
                  shape the world. This guide will help you understand the basics of survival in this unforgiving realm.
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        In Blothera, each death permanently reduces your maximum health by one heart (2 HP). This is a
                        core mechanic that makes survival meaningful. Be careful, plan ahead, and avoid unnecessary
                        risks.
                      </p>
                    </div>
                  </div>
                ...
                <p className="text-gray-300 mb-4">
                  Start by punching trees to gather wood. Craft a crafting table and wooden tools as soon as possible.
                  Prioritize creating a wooden pickaxe to mine stone, then craft stone tools for better durability.
                </p>
                ...
                <p className="text-gray-300 mb-4">Before nightfall, you need to secure a shelter. You can either:</p>
                ...
                <div className="my-8 bg-black/40 border border-gray-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Don't invest too much in your first shelter. Focus on survival first, then scout for a good
                        location for your permanent base. Consider factors like resource availability, terrain
                        defensibility, and proximity to other players or villages.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-gray-300 mb-4">
                  Hunger depletes faster in Blothera, making food a critical resource. Establish a sustainable food
                ...
                <p className="text-gray-300 mb-4">Once you've survived your first few days, you should focus on:</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-300 mt-6">
                  For more detailed information on specific topics, check out the related articles in the sidebar.
                </p>
              </div>
