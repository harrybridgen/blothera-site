        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-4 sticky top-20">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/wiki/getting-started/health-system" className="text-red-500 font-bold block py-1">Health System</Link></li>
          ...
          <div className="lg:col-span-3">
            <article className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-400 italic mb-6">Survival has a cost, and healing has a purpose</p>

              <div className="prose prose-invert max-w-none">
                <p className="text-gray-300 mb-4">
                  Blothera’s health system makes every injury matter. Healing isn’t free. And death? It’s permanent, at least in part.
                </p>

                <h2 className="text-2xl font-bold mt-8 mb-4 font-minecraft">DEATH PENALTY</h2>
                <p className="text-gray-300 mb-4">
                  Each time you die, your <strong>maximum health is reduced by 1 heart (2 HP)</strong>. This effect is permanent unless you restore it.
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        You cannot fall below <strong>4 hearts</strong> total health. You can still die, but your max HP won’t drop further after that point.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-gray-300 mb-4">
                  Natural regeneration is <strong>disabled</strong>. Eating food won’t heal you. These are the ways to heal:
                </p>
                <ul className="list-disc list-inside text-gray-300 space-y-1 mb-4">
                  <li><strong>Sleeping in a bed</strong> restores floor(missingHealth/2) hearts and has a chance to restore 1 Max HP</li>
                  <li><strong>Spicy Stews</strong> (dropped by mobs) offer tradeoffs like healing + side effects</li>
                  <li><strong>Golden Apples</strong>, good source of healing and gives 2 temporary hearts (and small chance to heal 1 Max HP)</li>
                  <li><strong>Enchanted Golden Apples</strong> increase your Max HP by 1 (up to 10 hearts) and provide temporary defences </li>
                  <li><strong>Potions</strong> offer temporary combat advantages</li>
                </ul>
                ...
                <div className="my-6 bg-black/40 border border-gray-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Regular Golden Apples <em>might</em> restore Max HP. Enchanted ones <strong>guarantee</strong> a Max HP boost.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-gray-300 mb-4">
                  Because healing is limited, every fight matters. Avoid fall damage, fight cautiously, and treat food as fuel, not medicine.
                </p>
              </div>
