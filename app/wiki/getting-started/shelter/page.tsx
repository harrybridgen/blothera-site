          ...
          <div className="lg:col-span-3">
            <article className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-400 italic mb-6">
                Your first line of defense against Blothera's dangers
              </p>

              <div className="prose prose-invert max-w-none">
                <p className="text-gray-300 mb-4">
                  In Blothera, nightfall isn’t just inconvenient, it’s deadly. Your shelter is your
                  safe zone. Here's how to make it count.
                </p>

                <h2 className="text-2xl font-bold mt-8 mb-4 font-minecraft">TYPES OF SHELTERS</h2>
                <ul className="list-disc list-inside text-gray-300 space-y-2 mb-4">
                  <li>
                    <strong>Quick Dirt Hut:</strong> Fast to build, decent early protection
                  </li>
                  <li>
                    <strong>Hillside Dugout:</strong> Easy to secure with one entrance
                  </li>
                  <li>
                    <strong>Village House:</strong> Reinforce an existing building with extra walls
                    and torches
                  </li>
                </ul>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Blood Zombies can break wooden doors, place a block behind it, or use fence
                        gates or trapdoors creatively.
                      </p>
                    </div>
                  </div>
                </div>
                <Anchor id="preparing-for-bloodmoons" />
                <h2 className="text-2xl font-bold mt-8 mb-4 font-minecraft">
                  PREPARING FOR BLOODMOONS
                </h2>
                <p className="text-gray-300 mb-4">
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-2 mb-4">
                  ...
                  <li>
                    Stay quiet, monsters can hear you. Sneak or walk if you must. DO NOT SPRINT!
                  </li>
                ...
                <div className="my-6 bg-black/40 border border-gray-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Fire spread is enabled. Use stone based materials to reduce the risk of your
                        home burning down during combat or lightning storms.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-gray-300 mt-6">
                  A proper shelter is more than a hiding place, it’s your launchpad into the world.
                  Build it right, and you’ll survive your first week.
                </p>
              </div>
