        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              ...
              className="bg-red-600 hover:bg-red-700 text-white font-minecraft px-6 py-3 rounded inline-block text-center"
            >
              JOIN THE WORLD
            </a>
          </div>
      ...
      <section className="py-16 bg-gray-900 border-t border-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-2 text-center">
            MINECRAFT WITH MEANING
          </h2>
          <p className="text-center italic text-sm text-gray-500 mb-6">
            No resets. No kits. No throwaway builds.
          </p>
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-gray-300 mb-2">
                      Blothera features a completely custom-built nations system that encourages
                      cooperation, diplomacy, and organized conflict, never random violence or
                      griefing.
                    </p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400">
                            Create a nation, design your banner, and establish your territory. Set
                            your own laws and governance style.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400">
                            Wars are formal, agreed-upon conflicts between nations. No random PvP or
                            griefing is ever allowed.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400">
                            Villagers are treated as players, not resources. No trading halls or
                            breeder farms, only real settlements.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400">
                            Semi-automatic farms are allowed. Fully automatic systems are not. The
                            land should feel lived in.
                          </p>
                        </div>
                      </div>
                    </div>
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">ITS ABOUT PURPOSE.</h2>
            <div className="bg-gray-900/50 border border-red-900/30 rounded-lg p-8 text-center max-w-3xl mx-auto">
              <p className="text-gray-300 text-lg mb-6">
                Modern servers are dopamine factories. Lootboxes. Starter kits. Skip buttons.
                Nothing matters because nothing is earned.
              </p>
              <p className="text-gray-300 text-lg mb-6">
                <span className="text-red-500 font-semibold">Blothera is different.</span>
                <br /> You struggle. You adapt. You leave your name behind.
              </p>
              <p className="text-gray-300 text-lg mb-6">
      ...
      <section className="py-16 bg-gradient-to-b from-black to-red-900/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="bg-black/50 border border-red-900/30 rounded-lg p-6 max-w-md mx-auto mb-8">
            ...
            <p className="text-xl text-white font-mono bg-gray-800/50 p-2 rounded mb-4">
              play.blothera.com
            </p>
