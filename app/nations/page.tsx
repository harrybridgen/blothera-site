      ...
      <section className="py-16 bg-gradient-to-b from-black to-gray-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="mb-16">
              <h2 className="text-3xl font-bold mb-6 font-minecraft text-red-500 text-center">FORGE A NATION</h2>
              <p className="text-gray-300 text-center">
                Nations in Blothera are not created through commands or claims. They are summoned. Only those who rise
                through survival may carve their name into the world.
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      There are no shortcuts. No /nation create. To lead a nation, you must prove something real. The
                      crown is not given. It is taken, from the heart of the End.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Build roads. Found towns. Write treaties in ink and trust. Nothing is automated. Everything is
                      seen. The world remembers what you build, and what you abandon.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Alliances are written, not clicked or typed. Vassals kneel in person. Every pact is placed, read,
                      and remembered. Nothing is truely hidden. Every choice leaves a trace in the world.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6 hover:border-red-500/30 transition-all">
              ...
              <p className="text-gray-300 mb-4">
                No backstabs. No random raids. Every war must be declared, every objective named, every sword lifted
                with purpose.
              </p>
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6 hover:border-red-500/30 transition-all">
              ...
              <p className="text-gray-300 mb-4">
                Battles don't happen on arenas. They happen in forests, mountains, and rivers, wherever the world
                chooses. You'll need maps, mounts, and real logistics.
              </p>
              <ul className="text-gray-400 text-sm space-y-1">
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6 hover:border-red-500/30 transition-all">
              ...
              <p className="text-gray-300 mb-4">
                Some battles are fought at the gates of real towns. For those, tools exist, heavy, slow, and loud. Only
                the bold will use them. Only the prepared will survive them.
              </p>
              <ul className="text-gray-400 text-sm space-y-1">
          ...
          <div className="max-w-4xl mx-auto bg-black/60 border border-gray-800 rounded-lg p-6">
            <div className="space-y-6">
              ...
              <div className="border-b border-gray-800 pb-6">
                ...
                <p className="text-gray-400 mb-4">
                  Red Valley wasn't supposed to be a war. A missed tribute. We mined under the ford and packed it with
                  lava. But they didn't come that way. They came through the treeline. On foot. Silent. By the time we
                  saw their flags, they were already inside. I dropped my sword and played dead beside a sheep. It
                  worked.
                </p>
              ...
              <div className="border-b border-gray-800 pb-6">
                ...
                <p className="text-gray-400 mb-4">
                  The Unionists had promised to defend us. They even sent a letter. Sealed and everything. But when the
                  sky turned red, no one came. We held for ten minutes before they breached the west gate. My brother
                  fell in the orchard. I left the nation the next day. Signed my own name in a different book.
                </p>
              ...
              <div>
                ...
                <p className="text-gray-400 mb-4">
                  ...
                  We passed around some loaves of bread and talked about trade routes. By the time the Bloodmoon rose,
                  we'd built something worth defending.
                </p>
